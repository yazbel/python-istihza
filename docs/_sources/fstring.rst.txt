...
f-string Formatlama Ozellikleri
********************************
...
``string`` metodlarında anlatılan ``center``, ``ljust``, ``rjust``, ``zfill`` metodlarının f-string içerisinde
``:`` işaretinden sonra karakter uzunluğu yazılarak, belirtilen karakter alanında hizalama yapılabilir.
