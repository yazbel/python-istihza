...
.. note::   Biz bu kitapta Python 3.7 kullanacağız. Aksi belirtilmediği sürece bütün kodların bu sürüm ile çalıştırıldığını varsayabilirsiniz.
...
.. warning:: 1 Ocak 2020 itibarıyla Python2'ye verilen destek bitmiştir. `Python Yazılım Vakfı
             <https://www.python.org/psf-landing/>`_ artık Python2.x sürümlerini geliştirmemektedir.
